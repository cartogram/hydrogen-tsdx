...
This monorepo is setup for a dummy `@shopify/` NPM organization. There are 2 packages by default:

- `@shopify/react` - A placholder React component
- `@shopify/utils` - A utils packages

Unlike other TSDX templates, the developer experience for this template is currently a bit more manual.

Your first order of business will be to search and replace `@shopify` for the npm organization of your own.
